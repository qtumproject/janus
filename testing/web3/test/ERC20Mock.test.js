 ...
 * 
 * If a log does not appear then it means the the even occured before the "latest" block
 * 
 * Test can be modified two filter by topics with the addition of fromBlock and toBlock to the
 * getPastLogs web3 function
 * 
 */
